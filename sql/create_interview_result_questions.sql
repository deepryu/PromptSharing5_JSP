...
-- 테이블 생성 확인
SELECT 'interview_result_questions 테이블이 성공적으로 생성되었습니다.' AS result;

-- 테이블 구조 확인 (pgAdmin 호환)
SELECT 
    column_name,
    data_type,
    is_nullable,
...
WHERE table_name = 'interview_result_questions'
